...
export const FIELD_FILTER_OPTIONS = {
  ...
  [FILTERABLE_FIELD_KEYS.AGE]: [
    FILTER_TYPES.EQUAL, FILTER_TYPES.LT, FILTER_TYPES.LTE, FILTER_TYPES.GT, FILTER_TYPES.GTE,
  ],
  [FILTERABLE_FIELD_KEYS.LEVEL]: [
    FILTER_TYPES.IN, FILTER_TYPES.LT, FILTER_TYPES.LTE, FILTER_TYPES.GT, FILTER_TYPES.GTE,
  ],
  [FILTERABLE_FIELD_KEYS.INC_TOTAL_ANNUAL]: [
    FILTER_TYPES.LT, FILTER_TYPES.LTE, FILTER_TYPES.GT, FILTER_TYPES.GTE,
  ],
