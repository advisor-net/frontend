...
import { Text, Heading, Box, Flex, Button, Grid, GridItem, Tooltip } from '@chakra-ui/react';
...
const SectionHeading = ({ title, tooltipInfo, isOwnProfile }) => (
  <Flex alignItems="center" marginBottom={2}>
    ...
    {isOwnProfile && <Button size="sm" colorScheme="teal">Edit</Button>}
  </Flex>
);
